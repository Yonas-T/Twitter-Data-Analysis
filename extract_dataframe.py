...
class TweetDfExtractor:
    ...
    def find_statuses_count(self)->list:
        ...
        statuses_count = [data['user']['statuses_count'] for data in self.tweets_list]
    ...
    def find_screen_name(self)->list:
        screen_name = [data['user']['screen_name'] for data in self.tweets_list]

        return screen_name

    def find_followers_count(self)->list:
        followers_count = [data['user']['followers_count'] for data in self.tweets_list]

        return followers_count

    def find_friends_count(self)->list:
        friends_count = [data['user']['friends_count'] for data in self.tweets_list]
        
        return friends_count

    def is_sensitive(self)->list:
        try:
            is_sensitive = [data['possibly_sensitive'] for data in self.tweets_list]
        except KeyError:
            is_sensitive = None
